...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quickSellPulish = __webpack_require__(26);

	var _quickSellPulish2 = _interopRequireDefault(_quickSellPulish);

	var _header_button = __webpack_require__(108);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleSubmit(e) {
	      e.preventDefault();
	      _reactDom2.default.findDOMNode(this.refs.form).submit();
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        { ref: 'form', action: '/ekp/form', method: 'post', name: 'quickSell', onSubmit: this.handleSubmit.bind(this) },
	        _react2.default.createElement(_header_button2.default, null),
	        _react2.default.createElement(_quickSellPulish2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _logicAction = __webpack_require__(27);
	...
	var _bread_crumb = __webpack_require__(84);

	var _bread_crumb2 = _interopRequireDefault(_bread_crumb);

	var _input3 = __webpack_require__(91);

	var _input4 = _interopRequireDefault(_input3);

	var _select3 = __webpack_require__(97);
	...
	var _quickSellRegin = __webpack_require__(103);

	var _quickSellRegin2 = _interopRequireDefault(_quickSellRegin);

	var _quickSellType = __webpack_require__(107);

	var _quickSellType2 = _interopRequireDefault(_quickSellType);
	...
	var ContainerComponent = _react2.default.createClass({
		...
		render: function render() {
			...
			var contractType = _props.contractType;
			var inventoryStatus = _props.inventoryStatus;
			var breadCrumb = _props.breadCrumb;
			var handleFormAction = _props.handleFormAction;

			return _react2.default.createElement(
				_Grid2.default,
				{ className: 'container-fluid container-self' },
				_react2.default.createElement(_bread_crumb2.default, { data: breadCrumb }),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_Col2.default,
						{ md: 4 },
						_react2.default.createElement(_quickSellRegin2.default, null)
					),
					_react2.default.createElement(
						_Col2.default,
						{ md: 3 },
						...
						_react2.default.createElement('input', { name: 'foldUser', value: '1', type: 'hidden' })
					),
					_react2.default.createElement(
						_Col2.default,
						{ md: 5 },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_quickSellType2.default, null)
				),
				_react2.default.createElement(
					_Row2.default,
					null,
	...
	function mapStateToProps(state) {
		return {
			...
			contractType: state.report.contractType,
			inventoryStatus: state.report.inventoryStatus,
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({
			handleFormAction: _logicAction.handleFormAction
		}, dispatch);
	}
	//将数据组件链接
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ContainerComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.handleQuickSellType = handleQuickSellType;
	exports.handleQuickSellChooseType = handleQuickSellChooseType;
	exports.handleFormAction = handleFormAction;
	 ...
	 */
	function handleQuickSellType(sellType) {
	  var equity;
	  if (sellType == 0) {
	    equity = {
	      isShowType: true,
	  ...
	  return {
	    type: _index.QUICKSELL_EQUITYTYPE,
	    equity: equity
	  };
	};
	 ...
	 * @return {[type]}            [description]
	 */
	function handleQuickSellChooseType(selectType) {
	  ...
	  return {
	    type: QUICKSELL_EQUITYNAME,
	    typeName: typeName
	  };
	}

	function handleFormAction(validate, name) {
	  ...
	  console.log(tmp);
	  return {
	    type: _index.QUICKSELL_PUBLISHFORM,
	    data: tmp
	  };
	}
...
/***/ function(module, exports) {
	...
	var RECEIVED_QUICKSELL_INITDATA = exports.RECEIVED_QUICKSELL_INITDATA = 'RECEIVED_QUICKSELL_INITDATA'; //速销调入数据初始化action
	var RECEIVED_SUBREGIN = exports.RECEIVED_SUBREGIN = 'RECEIVED_SUBREGIN'; //小区获取action
	var QUICKSELL_EQUITYTYPE = exports.QUICKSELL_EQUITYTYPE = 'QUICKSELL_EQUITYTYPE'; //押证逻辑处理action
	var QUICKSELL_EQUITYNAME = exports.QUICKSELL_EQUITYNAME = 'QUICKSELL_EQUITYNAME'; //押证选择类型action
	var QUICKSELL_PUBLISHFORM = exports.QUICKSELL_PUBLISHFORM = 'QUICKSELL_PUBLISHFORM'; //表单action
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPropTypesLibElementType = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$keys = __webpack_require__(51)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBootstrapUtils = __webpack_require__(60);
	...
	var InputBox = _react2.default.createClass({
	     ...
	     */
			...
			render: function render() {
					...
					var VerticalInput = _react2.default.createElement(_Input2.default, {
					...
					var HorizontalInput = _react2.default.createElement('div', { className: 'form-horizontal' }, _react2.default.createElement('label', { className: 'col-sm-5 control-label' }, this.state.labelName), _react2.default.createElement('div', { className: 'col-sm-7' }, _react2.default.createElement(_Input2.default, {
							type: this.state.type,
							value: this.state.value,
							placeholder: this.state.placeholder,
							help: this.state.help,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits = __webpack_require__(66)['default'];

	var _classCallCheck = __webpack_require__(73)['default'];

	var _interopRequireDefault = __webpack_require__(46)['default'];

	var _interopRequireWildcard = __webpack_require__(74)['default'];
	...
	var _InputBase2 = __webpack_require__(75);

	var _InputBase3 = _interopRequireDefault(_InputBase2);

	var _FormControls = __webpack_require__(78);

	var FormControls = _interopRequireWildcard(_FormControls);

	var _utilsDeprecationWarning = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(40).getDesc
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Glyphicon = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Static2 = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsChildrenValueInputValidation = __webpack_require__(80);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPropTypesLibSinglePropFrom = __webpack_require__(81);
	...
	var BreadCrumb = _react2.default.createClass({
		...
		render: function render() {
			...
			this.state.data.forEach(function (item, index) {
				item.active ? breadNodes.push(_react2.default.createElement(_BreadcrumbItem2.default, { key: index, active: true }, item.text)) : breadNodes.push(_react2.default.createElement(_BreadcrumbItem2.default, { key: index, href: item.url }, item.text));
			});
			return _react2.default.createElement(_Breadcrumb2.default, { data: this.state.data }, breadNodes);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties = __webpack_require__(86)['default'];
	...
	var _utilsValidComponentChildren = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateChainedFunction = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _input_base = __webpack_require__(92);
	...
	var _direct_box = __webpack_require__(95);

	var _direct_box2 = _interopRequireDefault(_direct_box);

	var _tips = __webpack_require__(96);
	...
	var Input = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    switch (this.state.inputType) {
	      case 'vertical':
	        return _react2.default.createElement(_direct_box2.default, { validateClass: this.state.validateClass, style: this.state.style }, _react2.default.createElement(_tips2.default, {
	          position: 'top',
	          tipText: this.state.tipText }), _react2.default.createElement(_label2.default, {
	          required: this.state.required,
	          text: this.state.labelName }), Input, _react2.default.createElement(_feedback2.default, { iconType: this.state.iconType }));
	        break;
	      case 'horizontal':
	        return _react2.default.createElement(_direct_box2.default, { className: 'form-horizontal', validateClass: this.state.validateClass }, _react2.default.createElement(_tips2.default, {
	          position: 'top',
	          tipText: this.state.tipText }), _react2.default.createElement(_label2.default, {
	          className: 'control-label col-sm-5',
	          required: this.state.required,
	          text: this.state.labelName }), _react2.default.createElement('div', { className: 'col-sm-7' }, Input, _react2.default.createElement(_feedback2.default, { iconType: this.state.iconType })));
	        break;
	      default:
	        return _react2.default.createElement(_direct_box2.default, { validateClass: this.state.validateClass, style: this.state.style }, _react2.default.createElement(_tips2.default, {
	          position: 'top',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectComponent = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement('div', { className: parentClass, style: this.props.style }, _react2.default.createElement('div', { className: validateClass }, this.props.children));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _select_base = __webpack_require__(99);
	...
	var Select = _react2.default.createClass({
		...
		handleOnBlur: function handleOnBlur(selectValue, selectText) {
		...
		render: function render() {
			...
			switch (this.state.selectType) {
				case 'vertical':
					return _react2.default.createElement(_direct_box2.default, { validateClass: this.state.validateClass }, _react2.default.createElement(_tips2.default, {
						position: 'top',
						tipText: this.state.tipText }), _react2.default.createElement(_label2.default, {
						required: this.state.required,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wdatePicker = __webpack_require__(101);
	...
	var _date_component = __webpack_require__(102);
	    ...
	    switch (this.state.dateType) {
	      case 'vertical':
	        return _react2.default.createElement(_direct_box2.default, { validateClass: this.state.validateClass }, _react2.default.createElement(_tips2.default, {
	          ...
	          tipText: this.state.tipText }), _react2.default.createElement(_label2.default, {
	          required: this.state.required,
	          text: this.state.labelName }), Dater, _react2.default.createElement(_feedback2.default, { iconType: this.state.iconType }));
	        break;
	      case 'horizontal':
	        return _react2.default.createElement(_direct_box2.default, { className: 'form-horizontal', validateClass: this.state.validateClass }, _react2.default.createElement(_tips2.default, {
	          position: 'top',
	          ...
	          className: 'control-label col-sm-5',
	          required: this.state.required,
	          text: this.state.labelName }), _react2.default.createElement('div', { className: 'col-sm-7' }, Dater, _react2.default.createElement(_feedback2.default, { iconType: this.state.iconType })));
	        break;
	      default:
	        return _react2.default.createElement(_direct_box2.default, { validateClass: this.state.validateClass }, _react2.default.createElement(_tips2.default, {
	          position: 'top',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchAction = __webpack_require__(104);
	...
	var ReginSelectComponent = function (_React$Component) {
	  _inherits(ReginSelectComponent, _React$Component);

	  function ReginSelectComponent(props) {
	    _classCallCheck(this, ReginSelectComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ReginSelectComponent).call(this, props));
	  }

	  _createClass(ReginSelectComponent, [{
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	      var requestQuickSellInitData = this.props.requestQuickSellInitData;
	    ...
	    value: function render() {
	      var _props = this.props;
	      var regin = _props.regin;
	      var subregin = _props.subregin;
	      var requestQuickSellSubreginData = _props.requestQuickSellSubreginData;

	      var reginOptions = regin.map(function (e) {
	        return {
	          value: e.id,
	          text: e.name
	        };
	      ...
	      var subreginOptions = [];
	      if (subregin) {
	        subreginOptions = subregin.map(function (e) {
	          return {
	            value: e.id,
	            text: e.name
	          };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_select2.default, {
	            ...
	            labelName: '大区',
	            required: 'true',
	            onBlur: requestQuickSellSubreginData,
	            options: reginOptions })
	        ),
	        _react2.default.createElement(
	          _Col2.default,
	          { md: 6 },
	          _react2.default.createElement(_select2.default, {
	            ...
	            labelName: '门店',
	            required: 'true',
	            options: subreginOptions })
	        )
	      );
	    }
	  }]);

	  return ReginSelectComponent;
	}(_react2.default.Component);
	...
	function mapStateToProps(state) {
	  return {
	    regin: state.regins.regin,
	    subregin: state.regins.subregin
	  };
	}
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({
	    requestQuickSellInitData: _fetchAction.requestQuickSellInitData,
	    requestQuickSellSubreginData: _fetchAction.requestQuickSellSubreginData
	  }, dispatch);
	}

	//将数据组件链接
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReginSelectComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.requestQuickSellInitData = requestQuickSellInitData;
	exports.requestQuickSellSubreginData = requestQuickSellSubreginData;
	 ...
	 */
	function requestQuickSellInitData() {
	  return function (dispatch) {
	    return (0, _isomorphicFetch2.default)('/examples/data.json').then(function (resp) {
	      return resp.json();
	    }).then(function (json) {
	      return dispatch(receivedQuickSellInitData(json));
	    });
	  };
	}
	...
	function receivedQuickSellInitData(quicksellInitData) {
	  var sellType = quicksellInitData.sellType;
	  var creditType = quicksellInitData.creditType;
	  var documentType = quicksellInitData.documentType;
	  var regin = quicksellInitData.regin;

	  return {
	    type: _index.RECEIVED_QUICKSELL_INITDATA,
	    sellTypes: sellType,
	 ...
	 * @return {[type]}            [description]
	 */
	function requestQuickSellSubreginData(subreginId) {
	  return function (dispatch) {
	    console.log('-------');
	    return (0, _isomorphicFetch2.default)('/examples/data1.json').then(function (resp) {
	      return resp.json();
	    }).then(function (json) {
	      return dispatch(receivedQuickSellSubreginData(json));
	    });
	  };
	}
	...
	function receivedQuickSellSubreginData(quicksellSubreginData) {
	  var subregin = quicksellSubreginData.subregin;

	  return {
	    type: _index.RECEIVED_SUBREGIN,
	    subregin: subregin
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SellTypeSelectComponent = function (_React$Component) {
			_inherits(SellTypeSelectComponent, _React$Component);

			function SellTypeSelectComponent(props) {
					_classCallCheck(this, SellTypeSelectComponent);

					return _possibleConstructorReturn(this, Object.getPrototypeOf(SellTypeSelectComponent).call(this, props));
			}

			_createClass(SellTypeSelectComponent, [{
					key: 'componentWillMount',
					value: function componentWillMount() {
							var requestQuickSellInitData = this.props.requestQuickSellInitData;
					...
					value: function render() {
							var _props = this.props;
							var quicksellType = _props.quicksellType;
							var isShowType = _props.isShowType;
							var isShowMoney = _props.isShowMoney;
							var handleQuickSellType = _props.handleQuickSellType;
							var creditTypes = _props.creditTypes;
							...
							return _react2.default.createElement(
									...
									_react2.default.createElement(
											...
											_react2.default.createElement(_select2.default, {
													...
													required: 'true',
													selectText: '请选择速销类型',
													onBlur: handleQuickSellType,
													options: quicksellType })
									),
									isShowType && _react2.default.createElement(
											_Col2.default,
											{ md: 3 },
											_react2.default.createElement(_select2.default, {
													name: 'equityType',
													...
													required: 'true',
													selectText: '请选择押证类型',
													onBlur: _logicAction.handleQuickSellChooseType,
													options: creditTypes })
									),
									isShowType && _react2.default.createElement(
											_Col2.default,
									...
									isShowMoney && _react2.default.createElement(
											_Col2.default,
											{ md: 3 },
			...
			return SellTypeSelectComponent;
	}(_react2.default.Component);
	//将state传递给props
	...
	function mapStateToProps(state) {
			return {
					quicksellType: state.types.quicksellType,
					isShowType: state.types.isShowType,
					isShowMoney: state.types.isShowMoney,
					creditTypes: state.types.creditTypes
			};
	}
	...
	function mapDispatchToProps(dispatch) {
			return (0, _redux.bindActionCreators)({
					requestQuickSellInitData: _fetchAction.requestQuickSellInitData,
					handleQuickSellType: _logicAction.handleQuickSellType,
					handleQuickSellChooseType: _logicAction.handleQuickSellChooseType
			}, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SellTypeSelectComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonItem = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('li', null, _react2.default.createElement(_Button2.default, { bsStyle: 'success', type: 'submit' }, this.props.children));
		}
	});
	var HeaderButton = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement('nav', { className: 'navbar navbar-fixed-top navbar-self', id: 'nav' }, _react2.default.createElement(_Grid2.default, { fluid: true }, _react2.default.createElement(_Row2.default, null, _react2.default.createElement(_Col2.default, { md: 4 }, _react2.default.createElement(_logo2.default, { src: this.state.logo })), _react2.default.createElement(_Col2.default, { md: 8 }, _react2.default.createElement(ButtonBox, { buttonList: this.state.buttonList })))));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logo = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(_Image2.default, { src: this.state.src, className: 'navbar-left img-logo' });
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _report = __webpack_require__(114);
	...
	var _regin = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function report() {
	  ...
	  switch (action.type) {
	    case _actions.QUICKSELL_EQUITYTYPE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function form() {
	  ...
	  switch (action.type) {
	    case _index.QUICKSELL_PUBLISHFORM:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function types() {
	  ...
	  switch (action.type) {
	    ...
	    //初始化相关内容
	    case _actions.RECEIVED_QUICKSELL_INITDATA:
	      return Object.assign({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function regins() {
	  ...
	  switch (action.type) {
	    ...
	    //接收并更新获取的小区数据
	    case _actions.RECEIVED_SUBREGIN:
	      return Object.assign({}, state, {
	        subregin: action.subregin
	      });
	    default:
