...
/***/ function(module, exports, __webpack_require__) {
	...
	var _header_simpleJs = __webpack_require__(70);

	var _header_simpleJs2 = _interopRequireDefault(_header_simpleJs);
	...
	var Header = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement('div', null, _react2['default'].createElement(_header_simpleJs2['default'], null));
		}
	});

	_reactDom2['default'].render(_react2['default'].createElement(Header, null), document.getElementById('nav'));
