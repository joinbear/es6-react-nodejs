...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsInputInput = __webpack_require__(111);

	var _componentsInputInput2 = _interopRequireDefault(_componentsInputInput);

	var _componentsSelectSelect = __webpack_require__(116);

	var _componentsSelectSelect2 = _interopRequireDefault(_componentsSelectSelect);

	var _componentsEditorEditor = __webpack_require__(119);
	...
	var Container = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement(_reactBootstrapLibGrid2['default'], { className: 'container-fluid container-self' }, _react2['default'].createElement(_componentsBread_crumb2['default'], { data: this.state.bread_crumb }), _react2['default'].createElement('p', null, '调入公告'), _react2['default'].createElement(_reactBootstrapLibRow2['default'], null, _react2['default'].createElement(_reactBootstrapLibCol2['default'], { md: 3 }, _react2['default'].createElement(_componentsInputInput2['default'], {
				...
				name: 'reginSlogan',
				labelName: '调入人',
				required: 'true' }))), _react2['default'].createElement(_reactBootstrapLibRow2['default'], null, _react2['default'].createElement(_reactBootstrapLibCol2['default'], { md: 6 }, _react2['default'].createElement(_componentsSelectSelect2['default'], { id: 'selectTest', name: 'TradeContract', selectType: 'normal', labelName: '速销类型' })), _react2['default'].createElement(_reactBootstrapLibCol2['default'], { md: 3 }, _react2['default'].createElement(_componentsInput2['default'], {
				inputType: 'vertical',
				ref: 'reginSlogan',
				name: 'reginSlogan',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _select_base = __webpack_require__(118);

	var _select_base2 = _interopRequireDefault(_select_base);

	var _inputDirect_box = __webpack_require__(114);

	var _inputDirect_box2 = _interopRequireDefault(_inputDirect_box);

	var _inputLabel = __webpack_require__(113);
	...
	var OptionsItem = _react2['default'].createClass({
		...
		render: function render() {
			var items = [],
			    _self = this;
			this.props.options.forEach(function (option, i) {
				items.push(_react2['default'].createElement('li', { key: i }, _react2['default'].createElement('a', { href: 'javascript:;', value: option.value, className: 'select-item' }, option.text)));
			});
			return _react2['default'].createElement('ul', { className: 'dropdown-menu' }, items);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectComponent = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement('div', { className: this.props.parentClassName }, _react2['default'].createElement('button', {
				type: 'button',
				className: 'btn btn-default dropdown-toggle',
				expanded: this.props.expanded,
				rel: this.props.name,
				selectValue: this.props.selectValue }, this.props.selectText, _react2['default'].createElement('span', { className: 'caret' })), _react2['default'].createElement('input', { type: 'hidden', value: this.props.selectValue, name: this.props.name }), _react2['default'].createElement(_options2['default'], { options: this.props.options }));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Simditor = __webpack_require__(122);
	...
	*/
	(function (root, factory) {
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(64),__webpack_require__(123),__webpack_require__(124),__webpack_require__(125)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, SimpleModule, simpleHotkeys, simpleUploader) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (root, factory) {
	  if (true) {
	    // AMD. Register as an anonymous module unless amdModuleId is set
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(64),__webpack_require__(123)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, SimpleModule) {
